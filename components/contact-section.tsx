          ...
          <div>
            ...
            <FadeInUp delay={0.16}>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <Link
                  href="#reservation"
                  className="inline-flex items-center justify-center rounded-full bg-slate-950 px-6 py-4 text-sm font-semibold text-white hover:-translate-y-0.5 hover:bg-teal-700"
                >
                  Réserver une consultation
                </Link>
                <a
                  href={contactInfo.phoneHref}
                  className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-6 py-4 text-sm font-semibold text-slate-700 hover:border-teal-200 hover:text-teal-700"
                >
              ...
              return (
                <StaggerItem key={card.title} className="h-full">
                  <a
                    ...
                    className="flex h-full flex-col rounded-[1.6rem] border border-slate-200 bg-white p-6 shadow-[0_18px_60px_-36px_rgba(15,23,42,0.35)] hover:-translate-y-1 hover:border-teal-200"
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-700 to-cyan-600 text-white">
